...
<head>
  ...
  <title>Dashboard - FootWearManager</title>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
		  ...
		  <li class="has_sub"><a href="#"><i class="fa fa-table"></i> Stock  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <li><a href="tables.html">Tables</a></li>
              <li><a href="dynamic-tables.html">Dynamic Tables</a></li>
            </ul>
          </li>
          <li><a href="charts.html"><i class="fa fa-bar-chart-o"></i>Suppliers Info</a></li>
        </ul>
    </div>
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <ul class="current-status">
                      <li>
                        <span id="status1"></span> <span class="bold">Sales : 2000</span>
                      </li>
                      <li>
                        <span id="status2"></span> <span class="bold">Summer shoes  : 1,345</span>
                      </li>
                      <li>
                        <span id="status3"></span> <span class="bold">Winter shoes  : 2000</span>
                      </li>
                      <li>
                        <span id="status4"></span> <span class="bold">Kids shoes : 500</span>
                      </li>
                      <li>
